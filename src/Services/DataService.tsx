...
async function CreateAccountBe(createdUser: object) {
  const result = await fetch('questerstavernbackend.azurewebsites.net/User/AddUser', {
      method: "POST",
      headers: {
...
async function Login(loginUser: object) {
  const result = await fetch('questerstavernbackend.azurewebsites.net/User/Login', {
      method: "POST",
      headers: {
          'Content-Type': "application/json"
      },
